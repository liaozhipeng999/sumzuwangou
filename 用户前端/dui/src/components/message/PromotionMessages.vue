<template>
  <div class="message-list-page">
    ...
    <div class="list-header">
      ...
      <span class="header-title">活动优惠</span>
      ...
      <van-pull-refresh v-model="refreshing" @refresh="onRefresh" success-text="刷新成功">
        ...
        >
          ...
          <van-empty
            ...
            image="search"
            :description="searchKeyword ? '没有找到匹配的消息' : '暂无活动优惠'"
          />
        </van-list>
      </van-pull-refresh>
    </div>
    ...
    >
      <div class="detail-popup" v-if="detailMessage">
        ...
        <div class="detail-meta">
          <van-icon name="gift-o" size="16" color="#ff6034" />
          <span class="detail-type">活动优惠</span>
...
const msgType: MessageType = 'promotion'
...
async function handleReadAll() {
  try {
    await showDialog({ title: '提示', message: '确定将所有活动消息标记为已读吗？', showCancelButton: true })
  } catch { return }
...
.message-card.unread { background: #fff7f0; }
