      ...
      <van-pull-refresh v-model="refreshing" @refresh="onRefresh" success-text="刷新成功">
        ...
        >
          ...
          <van-empty
            ...
            image="search"
            :description="searchKeyword ? '没有找到匹配的消息' : '暂无系统通知'"
          />
        </van-list>
      </van-pull-refresh>
    </div>
    ...
    >
      <div class="detail-popup" v-if="detailMessage">
        ...
        <div class="detail-meta">
          <van-icon name="bell" size="16" color="#909399" />
...
async function handleReadAll() {
  try {
    await showDialog({ title: '提示', message: '确定将所有系统通知标记为已读吗？', showCancelButton: true })
  } catch { return }
