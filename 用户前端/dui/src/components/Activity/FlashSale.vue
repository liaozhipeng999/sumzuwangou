<template>
  <div class="flash-sale-page">
    <!-- 顶部导航 -->
    <van-nav-bar title="限时秒杀" left-arrow @click-left="goBack" />
    ...
    <div class="products-section">
      <h3 class="section-title">今日秒杀商品</h3>
      ...
      <div v-else-if="products.length === 0" class="empty-state">
        <van-empty description="暂无秒杀商品" image="search" />
      </div>
    ...
    <div class="rules-section">
      ...
      <ul class="rules-list">
        <li>秒杀商品价格限时优惠，数量有限</li>
        <li>活动时间：每日 10:00 - 22:00</li>
        <li>每个用户限购1件，先到先得</li>
        <li>秒杀商品不支持退换货（质量问题除外）</li>
        <li>最终解释权归平台所有</li>
      </ul>
    </div>
  </div>
